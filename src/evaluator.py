def evaluator(data):
    ...
    Using https://github.com/kholia/IPIP-NEO-PI/blob/ng/app/evaluator.py
    Args:
    ...
    def score_return(i, low=45, high=55):
        trait = i[0]
        score = i[1]
        if(score < low):
            return {"trait": trait, "score": "Low"}
        elif(score > high):
            return {"trait": trait, "score": "High"}
        else:
            return {"trait": trait, "score": "Average"}

    personalities = [["Extraversion", SE],
        ["Agreeableness", SA],
